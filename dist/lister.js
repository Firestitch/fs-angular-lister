...
angular.module('fs-angular-lister').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('views/directives/lister.html',
    ...
    "\n" +
    "    <div layout=\"row\" layout-align=\"start\" class=\"search\" ng-show=\"options.filters.length\">\n" +
    ...
    "                        </span>\n" +
    "                    </div>\n" +
    "                    <div class=\"lister-col {{col.className}}\" ng-repeat=\"col in options.columns\" fs-lister-compile=\"col.title\" fs-column=\"col\" ng-style=\"columnStyle(col)\"></div>\n" +
