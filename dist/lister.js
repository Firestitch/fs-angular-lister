...
angular.module('fs-angular-lister').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('views/directives/lister.html',
    ...
    "        <div ng-show=\"options.inlineSearch\" layout=\"row\" class=\"ng-hide inline-search\" flex=\"100\">\n" +
    "            <div class=\"inline-search-input\" flex>\n" +
    ...
    "                </div>\n" +
    "            </div>\n" +
    "            <md-button ng-click=\"toogleSearch()\" class=\"md-icon-button\" aria-label=\"Search filters\">\n" +
    "                <md-icon>more_vert</md-icon>\n" +
    "            </md-button>\n" +
    "  \n" +
    "            <md-backdrop ng-show=\"extended_search\" ng-click=\"toogleSearch()\"></md-backdrop>\n" +
    "        </div>\n" +
    "\n" +
    "        <div flex ng-show=\"!options.inlineSearch\" class=\"ng-hide full-search\">\n" +
    ...
    "            </div>\n" +
    "        </div>\n" +
    "        <div class=\"top-actions\" layout=\"row\" layout-align=\"end center\" flex>\n" +
    ...
    "                    </span>\n" +
    "                </div>\n" +
    "                <div class=\"lister-col {{col.className}}\" ng-repeat=\"col in options.columns\" compile=\"col.title\"></div>\n" +
