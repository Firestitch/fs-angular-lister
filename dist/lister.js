...
angular.module('fs-angular-lister').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('views/directives/lister.html',
    ...
    "\n" +
    "                                    <md-input-container class=\"md-short-container md-block md-no-float\" ng-if=\"filter.multiple\">\n" +
    ...
    "                                    <md-input-container class=\"md-short-container md-block md-no-float\">\n" +
    ...
    "                                         <md-input-container class=\"md-short-container md-block filter-range-min\">\n" +
    "\n" +
    ...
    "                                         </md-input-container>\n" +
    "\n" +
    "                                         <md-input-container class=\"md-short-container md-block filter-range-max\">\n" +
    "\n" +
    "                                            <label>{{::filter.label}}</label>\n" +
    "                                            <input\n" +
    ...
    "\n" +
    "                                    <span class=\"md-block\">                \n" +
    "                                        <md-datepicker-container class=\"md-short-container md-block\">\n" +
    "                                            <label>{{::filter.label}}</label>\n" +
