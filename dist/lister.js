...
angular.module('fs-angular-lister').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('views/directives/lister.html',
    ...
    "\n" +
    "                                    <md-input-container class=\"md-no-float md-no-label md-no-message\" ng-if=\"filter.multiple\">\n" +
    ...
    "                    </div>\n" +
    "                    <div class=\"lister-col {{::col.className(item)}}\" ng-repeat=\"col in options.columns\" fs-lister-compile=\"dataCols[item.$$index][$index]\" fs-column=\"col\" fs-data=\"item\" ng-style=\"styleCols[$index]\"></div>\n" +
