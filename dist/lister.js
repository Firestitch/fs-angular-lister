...
angular.module('fs-angular-lister').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('views/directives/lister.html',
    ...
    "                        </span>\n" +
    "                    </div>\n" +
    "                    <div class=\"lister-col {{col.className}}\" ng-repeat=\"col in options.columns\" ng-style=\"columnStyle(col)\" ng-class=\"{ order: col.order }\" ng-click=\"headerClick(col)\">\n" +
    "                        \n" +
    "                        <span fs-lister-compile=\"col.title\" fs-column=\"col\"></span>\n" +
    "                        \n" +
    "                        <span ng-show=\"order.name==col.order.name\">\n" +
    "                            <md-icon ng-show=\"order.direction=='asc'\">arrow_downward</md-icon>\n" +
    "                            <md-icon ng-show=\"order.direction=='desc'\">arrow_upward</md-icon>\n" +
    "                        </span>\n" +
    "\n" +
    "                    </div>\n" +
    ...
    "                    </div>\n" +
    "                    <div class=\"lister-col {{col.column.className}}\" ng-repeat=\"col in item.cols\">\n" +
    "                        <div\n" +
    "                            fs-lister-compile=\"col.value\"\n" +
    "                            fs-column=\"col.column\"\n" +
    "                            fs-data=\"item.object\"\n" +
    "                            ng-style=\"columnStyle(col.column)\"\n" +
    "                            style=\"margin-left: {{::getColIndent(col.data, $index)}}\"\n" +
    "                            >\n" +
    "                        </div>\n" +
    "                    </div>\n" +
