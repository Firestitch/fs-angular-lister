...
angular.module('fs-angular-lister').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('views/directives/lister.html',
    ...
    "\n" +
    "    <div layout=\"row\" layout-align=\"start\" class=\"search\" ng-show=\"options.filters.length || options.topActions.length\" layout-align=\" end\">\n" +
    ...
    "\n" +
    "                            <div class=\"direction\" ng-show=\"column.order\">\n" +
